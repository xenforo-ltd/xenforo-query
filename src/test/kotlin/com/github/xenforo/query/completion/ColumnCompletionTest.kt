 ...
 *
 * Note: These tests verify the completion provider logic and context detection. Full integration tests require both the
 * PHP plugin and a database connection.
 */
